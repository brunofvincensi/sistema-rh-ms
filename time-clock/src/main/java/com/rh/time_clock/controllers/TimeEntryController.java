...
public class TimeEntryController {
    ...
    public ResponseEntity<?> record(@RequestBody @Valid TimeEntryRequest request) {
        ...
        timeEntryService.record(request, employeeId);
    ...
    public ResponseEntity<?> updateRecord(@PathVariable("id") String idTimeEntry,
        ...
        // Não pode alterar registro de ponto de outros colaboradores
        if (!Objects.equals(employeeId, timeEntryEntity.getEmployeeId())) {
